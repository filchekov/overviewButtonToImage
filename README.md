...
**out_id_or_element** - out dom element or out element id, use elements is elements witch support *innerHTML* property (if not set id will create automatically) <br />
